...
// 登录成功通知
static NSString * const XOLoginInDidSuccessNotification = @"XOLoginInDidSuccessNotification";
// 注销成功通知
static NSString * const XOLoginOutDidSuccessNotification = @"XOLoginOutDidSuccessNotification";
...
#define BG_TableColor           [UIColor colorWithRed:0.937255 green:0.937255 blue:0.956863 alpha:1.0]  // 网格背景色 颜色
#define BG_TableCellColor       [UIColor whiteColor]                                                    // 网格行 颜色
#define BG_TableSeparatorColor  [UIColor colorWithRed:0.783922 green:0.780392 blue:0.8 alpha:1.0]       // 网格 线 颜色
