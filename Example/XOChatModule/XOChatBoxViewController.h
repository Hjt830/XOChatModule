...
- (void)chatBoxViewController:(XOChatBoxViewController *)chatboxViewController sendAmrAudio:(NSString *)amrPath wavPath:(NSString *)wavPath audioDuration:(NSTimeInterval)duration;
