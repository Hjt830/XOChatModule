...
#define JTTextFont [UIFont systemFontOfSize:[JTSettingManager defaultManager].fontSize]

#define JTSubTextFont [UIFont systemFontOfSize:([JTSettingManager defaultManager].fontSize - 3)]
...
@interface JTSettingManager : NSObject
...
// 加载配置(初始化 Application:didFinishLaunchingWithOptions:中调用)
- (void)loadSetting;
